...
public class DoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(DoctorActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(DoctorActivity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(DoctorActivity.this, "Please grant location permissions in settings", Toast.LENGTH_LONG).show();
        } else {
        ...
        adapterDoctor = new FirebaseRecyclerAdapter<Doctor, ViewHolderDoctor>(options) {
            ...
            protected void onBindViewHolder(ViewHolderDoctor viewHolder, int position, final Doctor model) {
                ...
                viewHolder.bindToDoctor(model, mContext, myDistance.getDistance());
            }

        };
        recyclerViewDoctor.setAdapter(adapterDoctor);
        recyclerViewDoctor.startAnimation(AnimationUtils.loadAnimation(getApplicationContext(), R.anim.bounce));
