...
public class ViewHolderMasseuse extends RecyclerView.ViewHolder{
    ...
    public ViewHolderMasseuse(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void bindToMasseuse(final Masseuse model, final Context ctx, final String distance)
    {
