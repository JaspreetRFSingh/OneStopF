...
public class ViewHolderBeautician extends RecyclerView.ViewHolder{
    ...
    public ViewHolderBeautician(View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void bindToBeautician(final Beautician model, final Context ctx, final String distance)
    {
